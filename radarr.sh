#!/bin/bash
set -euo pipefail
# radarr multi-instance installer
# STiXzoOR 2025
# Usage: bash radarr.sh [--add|--remove [name] [--force]|--list|--register-panel]
...
_add_instance() {
    ...
    # Create config.xml (skip if user has existing config)
